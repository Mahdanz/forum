        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="kata.php" class="nav-link active">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  $data_hal = mysqli_query($koneksi, "SELECT * FROM tb_kata");
                  $jumlah_data = mysqli_num_rows($data_hal);
                  $total_halaman = ceil($jumlah_data / $batas);

                  if (isset($_GET['cari'])) {
                    $cari = $_GET['cari'];
                    $data = mysqli_query($koneksi, "SELECT * from tb_kata where kata like '%" . $cari . "%' ORDER BY id_kata ASC ");
                    while ($d = mysqli_fetch_array($data)) {
                  ?>

                                        <?php include 'listkata.php' ?>
                                        </tbody>
                    ...
                    $data = mysqli_query($koneksi, "SELECT * from tb_kata ORDER BY id_kata ASC limit $halaman_awal, $batas   ");
