    ...
    <ul class="navbar-nav">
        ...
        <li>
            ...
            <div class="form-inline">
                <form action="postingan.php" method="get">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="postingan.php" class="nav-link active">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  $data_hal = mysqli_query($koneksi, "select * from tb_lapor WHERE target='postingan'");
                  $jumlah_data = mysqli_num_rows($data_hal);
                  $total_halaman = ceil($jumlah_data / $batas);

                  if (isset($_GET['cari'])) {
                    $cari = $_GET['cari'];
                    $data = mysqli_query($koneksi, "select * from tb_lapor inner join tb_alasanlapor on tb_lapor.id_alasanlapor = tb_alasanlapor.id_alasanlapor where target ='postingan' AND tgl like '%" . $cari . "%' OR deskripsi_tambahan like '%" . $cari . "%' OR judul like '%" . $cari . "%' ORDER BY id_lapor DESC ");
                    while ($d = mysqli_fetch_array($data)) {
                  ?>
                                <?php include 'listpostingan.php' ?>
                            </tbody>
                            <!-- MODAL EDIT -->
                    ...
                    $data = mysqli_query($koneksi, "SELECT * from tb_lapor inner join tb_alasanlapor on tb_lapor.id_alasanlapor = tb_alasanlapor.id_alasanlapor where target ='postingan' ORDER BY id_lapor DESC limit $halaman_awal, $batas");
