        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  if (isset($_GET['cari'])) {
                    $cari = $_GET['cari'];
                    $data = mysqli_query($koneksi, "select * from tb_lapor inner join tb_alasanlapor on tb_lapor.id_alasanlapor = tb_alasanlapor.id_alasanlapor where target ='komentar' AND tgl like '%" . $cari . "%' OR deskripsi_tambahan like '%" . $cari . "%' OR judul like '%" . $cari . "%' ORDER BY id_lapor DESC ");
