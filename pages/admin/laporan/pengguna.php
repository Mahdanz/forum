                ...
                <form action="pengguna.php" method="get">
                    <div class="input-group">
                        <input class="form-control form-control-sidebar" type="search" placeholder="Cari..."
                            aria-label="Search" name="cari" style="width: 26rem;" />
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="postingan.php" class="brand-link">
...
<?php 
$data_laporan1 = mysqli_query($koneksi,"SELECT * FROM tb_postingan");
$data_laporan2 = mysqli_query($koneksi,"SELECT * FROM tb_komentar");
$data_laporan3 = mysqli_query($koneksi,"SELECT * FROM tb_pengguna");
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  $data_hal = mysqli_query($koneksi, "select * from tb_lapor WHERE target='pengguna'");
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $data = mysqli_query($koneksi, "select * from tb_lapor inner join tb_alasanlapor on tb_lapor.id_alasanlapor = tb_alasanlapor.id_alasanlapor INNER JOIN tb_pengguna ON tb_lapor.id_pengguna = tb_pengguna.id_penggunawhere target ='pengguna' AND tgl like '%" . $cari . "%' OR deskripsi_tambahan like '%" . $cari . "%' OR judul like '%" . $cari . "%' ORDER BY id_lapor DESC ");
                    while ($d = mysqli_fetch_array($data)) {
                  ?>
                                <?php include 'listpengguna.php' ?>
                            </tbody>
                            <!-- MODAL EDIT -->
                    ...
                    $data = mysqli_query($koneksi, "select * from tb_lapor inner join tb_alasanlapor on tb_lapor.id_alasanlapor = tb_alasanlapor.id_alasanlapor INNER JOIN tb_pengguna ON tb_lapor.id_pengguna = tb_pengguna.id_pengguna where target ='pengguna' ORDER BY id_lapor DESC limit $halaman_awal, $batas   ");
