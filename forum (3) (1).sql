...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2022 at 04:03 PM
...
(11, 'Mahdan', 'ahmad@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '2000-12-22', '11Mahdan-22 08 2022augen-zoom.gif', '11Mahdan-22 08 2022augen-zoom.gif', 'Sangat menyukai tantangan', 'Saya sedang melaksanakan Ujian Semina Hasil, Doakan kelancaran dan keberhasilan untuk saya, aamiin', 'Mahasiswa tingkat akhir', 'Politeknik Negeri Banyuwangi', 'Jakarta', '2022-08-15'),
...
--
ALTER TABLE `tb_kata`
  MODIFY `id_kata` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `tb_komentar`
--
ALTER TABLE `tb_komentar`
  MODIFY `id_komentar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT for table `tb_lapor`
--
ALTER TABLE `tb_lapor`
  MODIFY `id_lapor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
